	   ...
	   # queryString3 = "INSERT IGNORE INTO SEMESTER" + row[1].to_s + "(CRN, SUBJ, CRS, SEC, TITLE, CH, MAX, ENR,
		...
		@@queryString3 = "INSERT IGNORE INTO SEMESTER201501(CRN, SUBJ, CRS, SEC, TITLE, CH, MAX, ENR, 
                AVAIL, WL, DAYS, STIME, ETIME, ROOM, WK, INSTRUCTOR, EF, STARTSON) VALUES(" + 
                 @@conversion[0] + ",\'" + @@conversion[1] + "\'," + @@conversion[2] + "," + @@conversion[3] + ",\'" + @@conversion[4]+ "\'," + @@conversion[5] + "," + @@conversion[6] + "," + @@conversion[7] + "," + @@conversion[8] + "," + @@conversion[9] + ",\'" +  @@conversion[10]+ "\'," + @@conversion[11] + "," + @@conversion[12] + ",\'" + @@conversion[13] + "\'," + @@conversion[14] + ",\'" + @@conversion[15] + "\',\'" + @@conversion[16] + "\',\'" + @@conversion[17] + "\')" 
