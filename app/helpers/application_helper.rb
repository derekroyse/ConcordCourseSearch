	...
	while x < 18
	  ...
	  x+=1
	   ...
	   # queryString3 = "INSERT IGNORE INTO SEMESTER" + row[1].to_s + "(CRN, SUBJ, CRS, SEC, TITLE, CH, MAX, ENR,
		...
		@@queryString3 += @@conversion[4]+ "\'," + @@conversion[5] + "," + @@conversion[6] + "," + @@conversion[7] + "," + @@conversion[8] + "," + @@conversion[9] + ",\'" +  @@conversion[10]+ "\'," + @@conversion[11] + "," + @@conversion[12] + ",\'" + @@conversion[13] + "\'," + @@conversion[14] + ",\'" + @@conversion[15] + "\',\'" + @@conversion[16] + "\',\'" + @@conversion[17] + "\')" 
